window.jwplayer = function (e) {
    ...
    var o = n(16), a = n(10), u = n(11), c = n(1), s = n(21), l = n(19), f = n(0), d = n(29), p = n(25), v = n(26),
        h = n(52);
    n.d(t, "b", function () {
        return g
    });
    ...
    function r() {
        var returnValue = !!window.MediaSource && !!window.MediaSource.isTypeSupported && window.MediaSource.isTypeSupported('video/mp4;codecs="avc1.4d400d,mp4a.40.2"')

        console.log("Check for support: " + returnValue);
        return returnValue;
    }

    function i(e, t) {
        if (f.Browser.safari) return !1;
        if (!Object(d.a)(t)("dash")) {
            return !1;
        }
    ...
    function o(e, t) {
        var n = e.sources, i = t.get("androidhls"), o = e.drm || t.get("drm"),
            a = c(e.withCredentials, t.get("withCredentials")), u = !1 !== t.get("hlsjsdefault");
    ...
    $(g.prototype, {
        getAllItems: function () {
            ...
            return this.items.reduce(function (t, n) {
                ...
                if (!K) {
                    K = window.StorageShim;
                }

                console.log('K=' + K + ', e.namespace=' + e.namespace + ', window.StorageShim=' + window.StorageShim);
    ...
    re(oe.prototype, {
        on: ee.a.on, once: ee.a.once, off: ee.a.off, trigger: ee.a.trigger, init: function (e, t) {
            var n = this, r = this.modelShim, i = new Y("jwplayer", ["volume", "mute", "captionLabel", "qualityLabel"]),
                o = i && i.getAllItems();
    ...
    var v = d, h = n(20), m = n(19), g = n(12), y = n(45), b = n(4), w = n(21), j = n(7), O = n(6), k = n(0),
...
var jwDefaults = {
    "key": "0XvJx9mEbWXvoXMH+D6AwKnXvaO1wd8KrpGDr07PLn50MkCn4mKUpGKSAwg=",
    "ph": 1,
    "pid": "DEFAULT0"
};
